...
if (args.length !== 2) {
  ...
  output +='<p><span style="font-size: 14px;"><br/></span></p><p>  <strong><span style="font-size: 14px;">成员互动</span></strong></p><p><span style="font-size: 14px;"><br></span></p><p><br/></p><p><strong><span style="font-size: 14px;">公众号自动回复指令说明</span></strong></p><ul class=" list-paddingleft-2" style="list-style-type: disc;"><li><p><span style="font-size: 14px;">?: 指令说明</span></p></li><li><p><span style="font-size: 14px;">ev: 48系番组直播间节目表</span></p></li><li><p><span style="font-size: 14px;">perf: 当日HKT48公演信息</span></p></li><li><p><span style="font-size: 14px;">hkt: HKT48冷知识</span></p></li><li><p><span style="font-size: 14px;">haruppi: 兒玉遥迷你档案</span></p></li><li><p><span style="font-size: 14px;">任何建议请直接留言😝</span></p></li></ul><hr/><p><span style="font-size: 14px;">翻译: @迈克肉丝 @根基挡炎爆 @Nakateru</span></p><p><span style="font-size: 14px;">部分内容摘自微博 @2ch儿玉遥应援串</span></p><p><span style="font-size: 14px;">百科: http://haruppipedia.org</span></p><p><span style="font-size: 14px;">应援微博: @儿玉遥应援会</span></p><p><span style="font-size: 14px;">百度儿玉遥吧</span></p><p><span style="font-size: 14px;">应援Q群: 285383195</span></p><p>'

  output = `var date=new Date();y=date.getFullYear();m=date.getMonth()+1;d=date.getDate();var title=y+'.'+(m>9?m:'0'+m)+'.'+(d>9?d:'0'+d);title='${title}';$('input.js_title').value=title;UE.instants.ueditorInstant0.setContent('${output}')`
